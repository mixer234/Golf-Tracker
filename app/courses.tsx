                ...
                <View style={styles.cardBody}>
                  ...
                  {courseRounds.length > 0 && (
                    <View style={styles.perfRow}>
                      ...
                      <View style={styles.perfDivider} />
                      <View style={styles.perfItem}>
                        <Text style={[styles.perfValue, { color: Colors.midGreen }]}>{bestScore}</Text>
              ...
              <View style={styles.teeRow}>
                {TEE_COLORS.map((t) => (
                  ...
                  >
                    ...
                    <Text style={[styles.teeChipText, defaultTee === t.key && { color: Colors.textPrimary }]}>{t.label}</Text>
                  </TouchableOpacity>
                ))}
              </View>
...
const chipStyles = StyleSheet.create({
  ...
  value: { fontSize: FontSize.sm, fontWeight: '800', color: Colors.textPrimary },
});
...
const styles = StyleSheet.create({
  ...
  back: { fontSize: FontSize.sm, color: Colors.darkGreen, fontWeight: '600', minWidth: 60 },
  ...
  addBtnText: { fontSize: FontSize.sm, fontWeight: '700', color: '#ffffff' },
  ...
  emptyBtnText: { fontSize: FontSize.base, fontWeight: '700', color: '#ffffff' },
  card: {
    flexDirection: 'row',
  ...
  courseName: { fontSize: FontSize.md, fontWeight: '800', color: Colors.textPrimary },
  ...
  perfValue: { fontSize: FontSize.md, fontWeight: '800', color: Colors.textPrimary },
  ...
  editHint: { fontSize: FontSize.xs, color: Colors.darkGreen, fontWeight: '600' },
  ...
  modalSave: { fontSize: FontSize.base, fontWeight: '700', color: Colors.darkGreen },
  modalContent: { padding: Spacing.lg, gap: 4, paddingBottom: Spacing.xxl },
  inputLabel: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.textPrimary, marginBottom: 6 },
