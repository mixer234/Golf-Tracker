...
const styles = StyleSheet.create({
  ...
  optionCardActive: { borderColor: Colors.darkGreen, backgroundColor: Colors.primaryPale },
  optionValue: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.textSecondary },
  optionValueActive: { color: Colors.primary, fontWeight: '600' },
  ...
  facilityChipActive: { borderColor: Colors.darkGreen, backgroundColor: Colors.primaryPale },
