...
const drillStyles = StyleSheet.create({
  ...
  nameCompleted: { textDecorationLine: 'line-through', color: Colors.textLight },
  ...
  durationText: { fontSize: FontSize.xs, color: Colors.textLight, fontWeight: '600' },
...
const styles = StyleSheet.create({
  ...
  generateButtonText: { fontSize: FontSize.base, fontWeight: '700', color: '#ffffff' },
  loadingState: {
    flex: 1,
    alignItems: 'center',
    justifyContent: 'center',
  ...
  regenerateText: { fontSize: FontSize.base, fontWeight: '600', color: Colors.textSecondary },
  bagHeader: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  sessionDay: { fontSize: FontSize.xl, fontWeight: '800', color: '#ffffff' },
  sessionProgress: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.7)', marginTop: 2 },
  elapsedBadge: {
  ...
  countdownLabel: { fontSize: FontSize.xs, color: 'rgba(255,255,255,0.7)', fontWeight: '600', marginTop: 2 },
  autoAdvanceBanner: {
    ...
    paddingVertical: Spacing.sm,
    borderWidth: 1,
    borderColor: 'rgba(151,196,89,0.4)',
  },
  autoAdvanceText: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.primaryLight },
  ...
  sessionSkipText: { fontSize: FontSize.base, fontWeight: '600', color: 'rgba(255,255,255,0.75)' },
  sessionDoneBtn: {
    flex: 2,
    paddingVertical: 14,
    borderRadius: Radius.full,
  ...
  sessionDoneText: { fontSize: FontSize.base, fontWeight: '700', color: Colors.darkGreen },
  sessionCancelRow: {
    alignItems: 'center',
    paddingVertical: Spacing.md,
    paddingBottom: Spacing.lg,
  },
  sessionCancelText: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.45)', textDecorationLine: 'underline' },
  ...
  restHeading: { fontSize: FontSize.xxxl, fontWeight: '800', color: '#ffffff' },
  restSub: { fontSize: FontSize.base, color: 'rgba(255,255,255,0.7)', marginTop: -Spacing.md },
  restCountdownText: {
    fontSize: FontSize.xxxl,
    fontWeight: '800',
  ...
  skipRestText: { fontSize: FontSize.base, fontWeight: '700', color: '#ffffff' },
  nextDrillPreview: {
    width: '100%',
  ...
  nextDrillName: { fontSize: FontSize.md, fontWeight: '700', color: '#ffffff' },
  nextDrillDesc: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.7)', lineHeight: 20 },
  ...
  celebHeading: { fontSize: FontSize.xxxl, fontWeight: '800', color: '#ffffff', textAlign: 'center' },
  celebSub: { fontSize: FontSize.base, color: 'rgba(255,255,255,0.7)', textAlign: 'center', lineHeight: 22, marginTop: -Spacing.sm },
  celebStats: {
    flexDirection: 'row',
    backgroundColor: 'rgba(255,255,255,0.1)',
    borderRadius: Radius.xl,
  ...
  celebStatNum: { fontSize: FontSize.xxl, fontWeight: '800', color: '#ffffff' },
  celebStatLabel: { fontSize: FontSize.xs, color: 'rgba(255,255,255,0.65)', fontWeight: '600' },
  celebStatDivider: { width: 1, backgroundColor: 'rgba(255,255,255,0.2)', marginVertical: 4 },
  focusBadge: {
    backgroundColor: 'rgba(151,196,89,0.2)',
    borderRadius: Radius.full,
    paddingHorizontal: Spacing.lg,
  ...
  focusBadgeText: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.primaryLight },
  celebActions: {
    alignSelf: 'stretch',
    gap: Spacing.sm,
    marginTop: Spacing.sm,
  ...
  celebPrimaryText: { fontSize: FontSize.base, fontWeight: '700', color: Colors.darkGreen },
  celebSecondaryBtn: {
    borderRadius: Radius.full,
    paddingVertical: 14,
    alignItems: 'center',
  ...
  celebSecondaryText: { fontSize: FontSize.base, fontWeight: '600', color: 'rgba(255,255,255,0.8)' },
});
