            ...
            {averages && (
              <View style={styles.section}>
                ...
                <View style={styles.overallCard}>
                  ...
                  <View style={barStyles.row}>
                    <Text style={[barStyles.label, { fontWeight: '700', color: Colors.textPrimary }]}>Total</Text>
                    <View style={barStyles.track}>
                      <View style={barStyles.center} />
                      {averages.sgTotal >= 0 ? (
...
const cardStyles = StyleSheet.create({
  ...
  course: { fontSize: FontSize.base, fontWeight: '700', color: Colors.textPrimary },
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: FontSize.xxl, fontWeight: '800', color: Colors.textPrimary, marginBottom: 6, letterSpacing: -0.5 },
  ...
  stepNumText: { fontSize: FontSize.xs, fontWeight: '800', color: '#ffffff' },
  ...
  startBtnText: { fontSize: FontSize.base, fontWeight: '700', color: '#ffffff' },
});
