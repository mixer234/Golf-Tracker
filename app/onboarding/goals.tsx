...
const styles = StyleSheet.create({
  ...
  goalCardActive: { borderColor: Colors.darkGreen, backgroundColor: Colors.primaryPale },
  radio: {
  ...
  radioInner: { width: 10, height: 10, borderRadius: Radius.full, backgroundColor: Colors.darkGreen },
  goalText: { flex: 1 },
  ...
  timelineCardActive: { borderColor: Colors.darkGreen, backgroundColor: Colors.primaryPale },
  ...
  doneBtn: { flex: 2, backgroundColor: Colors.darkGreen, paddingVertical: 16, alignItems: 'center', borderRadius: Radius.full },
