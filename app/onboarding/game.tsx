...
const styles = StyleSheet.create({
  ...
  title: { fontSize: FontSize.xxl, fontWeight: '600', color: Colors.text, lineHeight: 34, letterSpacing: -0.5, marginBottom: 8 },
  ...
  areaChipWeakness: { borderColor: Colors.error, backgroundColor: Colors.error + '18' },
  areaChipStrength: { borderColor: Colors.success, backgroundColor: Colors.success + '18' },
  areaChipMiss: { borderColor: Colors.warning, backgroundColor: Colors.warning + '18' },
  areaEmoji: { fontSize: 20 },
  areaLabel: { flex: 1, fontSize: FontSize.base, fontWeight: '500', color: Colors.textSecondary },
  ...
  nextBtn: { flex: 2, backgroundColor: Colors.darkGreen, paddingVertical: 16, alignItems: 'center', borderRadius: Radius.full },
