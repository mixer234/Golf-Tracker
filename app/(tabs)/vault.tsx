...
const styles = StyleSheet.create({
  ...
  compareBtnText: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.primary },
  recordBtn: {
  ...
  recordBtnText: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.background },
  filterRow: {
    flexDirection: 'row',
    gap: Spacing.sm,
    paddingHorizontal: Spacing.lg,
  ...
  upsellTitle: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.text },
  ...
  clubBadgeText: { fontSize: 9, fontWeight: '700', color: Colors.background },
  slowMoBadge: {
...
const renameStyles = StyleSheet.create({
  ...
  saveText: { fontSize: FontSize.base, fontWeight: '700', color: Colors.background },
});
