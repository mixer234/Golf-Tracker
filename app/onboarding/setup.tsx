...
const styles = StyleSheet.create({
  ...
  expCardActive: { borderColor: Colors.darkGreen, backgroundColor: Colors.primaryPale },
  expEmoji: { fontSize: 22, width: 30 },
  expLabel: { fontSize: FontSize.base, fontWeight: '600', color: Colors.textSecondary, flex: 1 },
  expLabelActive: { color: Colors.primary, fontWeight: '600' },
  ...
  sgTipIcon: { fontSize: 12, color: Colors.primary, fontWeight: '700', marginTop: 2 },
