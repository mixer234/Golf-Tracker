        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.teeScroll}>
          {TEE_COLORS.map((t) => (
            ...
            >
              ...
              <Text style={[styles.teeChipText, selectedTee === t.key && { color: Colors.textPrimary }]}>
                {t.label}
              </Text>
            </TouchableOpacity>
          ))}
...
function HoleRow({
  ...
  const parColor = PAR_COLORS[hole.par] ?? Colors.darkGreen;
...
const statStyles = StyleSheet.create({
  ...
  value: { fontSize: FontSize.sm, fontWeight: '800', color: Colors.textPrimary, marginTop: 2 },
});
...
const rowStyles = StyleSheet.create({
  ...
  inputFilled: { borderColor: Colors.darkGreen + '80', backgroundColor: Colors.paleGreen },
  inputSI: {
    width: 36,
    backgroundColor: Colors.surface,
    borderWidth: 1,
...
const styles = StyleSheet.create({
  ...
  back: { fontSize: FontSize.sm, color: Colors.darkGreen, fontWeight: '600', minWidth: 70 },
  ...
  parLabel: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.darkGreen },
  teeBar: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  nineLabel: { fontSize: 9, fontWeight: '700', color: Colors.darkGreen, letterSpacing: 1 },
  nineTotal: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: Spacing.md,
  ...
  nineTotalLabel: { fontSize: FontSize.xs, fontWeight: '800', color: Colors.darkGreen, width: 30 },
  nineTotalVal: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.textPrimary },
