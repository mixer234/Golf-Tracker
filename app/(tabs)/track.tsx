            ...
            return (
              <View style={styles.summaryCard}>
                ...
                <Text style={[
                  ...
                  stp < 0 ? { color: Colors.success } : stp > 0 ? { color: Colors.error } : { color: Colors.textPrimary },
                ]}>
                  {headline}
                </Text>
...
const holeStyles = StyleSheet.create({
  ...
  holeLabel: { fontSize: FontSize.xl, fontWeight: '800', color: Colors.textPrimary },
  scoreBadge: {
  ...
  scoreBadgeText: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.textPrimary },
  row: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  rowLabel: { fontSize: FontSize.base, fontWeight: '500', color: Colors.textPrimary, flexShrink: 1 },
  ...
  segActive: { backgroundColor: Colors.darkGreen, borderColor: Colors.darkGreen },
  ...
  counterBtnText: { fontSize: FontSize.xl, color: Colors.textPrimary, fontWeight: '300', lineHeight: 24 },
  counterVal: { fontSize: FontSize.xl, fontWeight: '800', color: Colors.textPrimary, minWidth: 32, textAlign: 'center' },
  ...
  sgToggleHint: { fontSize: FontSize.xs, color: Colors.darkGreen },
  sgSection: {
  ...
  sgLabel: { fontSize: FontSize.sm, fontWeight: '500', color: Colors.textPrimary, flex: 1, flexShrink: 1 },
  sgInput: {
    backgroundColor: Colors.background,
    borderWidth: 1.5,
    borderColor: Colors.border,
  ...
  lieSegActive: { backgroundColor: Colors.darkGreen, borderColor: Colors.darkGreen },
  ...
  missCellTextActive: { color: Colors.textPrimary },
});
...
const styles = StyleSheet.create({
  ...
  courseName: { fontSize: FontSize.xl, fontWeight: '800', color: '#fff' },
  roundSubtitle: { fontSize: FontSize.sm, color: 'rgba(255,255,255,0.7)' },
  ...
  discardText: { fontSize: FontSize.sm, fontWeight: '600', color: 'rgba(255,255,255,0.8)' },
  completeBtn: {
    paddingHorizontal: 14,
    paddingVertical: 8,
    borderRadius: Radius.circle,
  ...
  completeText: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.darkGreen },
  scoreSummary: {
    flexDirection: 'row',
    paddingHorizontal: Spacing.lg,
  ...
  scoreBoxVal: { fontSize: FontSize.lg, fontWeight: '800', color: Colors.textPrimary },
  ...
  holeChipActive: { backgroundColor: Colors.darkGreen, borderColor: Colors.darkGreen },
  holeChipDone: { backgroundColor: Colors.paleGreen, borderColor: Colors.midGreen },
  ...
  summaryCourse: { fontSize: FontSize.md, fontWeight: '700', color: Colors.textPrimary },
  ...
  noRoundTitle: { fontSize: FontSize.xxl, fontWeight: '800', color: Colors.textPrimary, marginBottom: Spacing.sm },
  noRoundText: {
    fontSize: FontSize.base,
    color: Colors.textSecondary,
    textAlign: 'center',
  ...
  historyTitle: { fontSize: FontSize.md, fontWeight: '700', color: Colors.textPrimary, marginBottom: Spacing.xs },
  historyRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  historyCourse: { fontSize: FontSize.base, fontWeight: '600', color: Colors.textPrimary },
  ...
  historyDiff: { fontSize: FontSize.xs, color: Colors.midGreen, marginTop: 2, fontWeight: '600' },
  historyNotes: { fontSize: FontSize.xs, color: Colors.textLight, marginTop: 2, fontStyle: 'italic' },
  historyScores: { alignItems: 'flex-end' },
  historyTotal: { fontSize: FontSize.xl, fontWeight: '800', color: Colors.textPrimary },
  ...
  modalStart: { fontSize: FontSize.base, fontWeight: '700', color: Colors.darkGreen },
  ...
  roundTypeChipActive: { borderColor: Colors.darkGreen, backgroundColor: Colors.paleGreen },
  roundTypeText: { fontSize: FontSize.sm, fontWeight: '600', color: Colors.textSecondary },
  roundTypeTextActive: { color: Colors.darkGreen },
  mentalRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
