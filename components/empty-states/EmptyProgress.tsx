...
function ChartIllustration() {
  return (
    <Svg width={120} height={120} viewBox="0 0 120 120">
      {/* Axes */}
      <Line x1="20" y1="95" x2="105" y2="95" stroke={Colors.primary} strokeWidth={2} strokeLinecap="round" opacity={0.4} />
      <Line x1="20" y1="20" x2="20" y2="95" stroke={Colors.primary} strokeWidth={2} strokeLinecap="round" opacity={0.4} />
      ...
      {/* Data dots */}
      <Circle cx="25" cy="85" r="3.5" fill={Colors.primary} opacity={0.6} />
      <Circle cx="45" cy="72" r="3.5" fill={Colors.primary} opacity={0.6} />
      <Circle cx="62" cy="60" r="3.5" fill={Colors.primary} opacity={0.6} />
      <Circle cx="78" cy="45" r="3.5" fill={Colors.primary} opacity={0.6} />

      {/* Golf ball at the tip */}
      <Circle cx="95" cy="30" r="8" fill={Colors.primary} />
