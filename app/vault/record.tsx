...
export default function RecordScreen() {
  ...
  const progressColor = elapsed >= WARN_AT ? Colors.warning : Colors.darkGreen;
...
const styles = StyleSheet.create({
  ...
  settingChipActive: { borderColor: Colors.darkGreen, backgroundColor: 'rgba(59,109,17,0.2)' },
  ...
  settingTextActive: { color: Colors.darkGreen },
...
const saveStyles = StyleSheet.create({
  ...
  clubChipActive: { borderColor: Colors.darkGreen, backgroundColor: Colors.paleGreen },
  clubText: { fontSize: FontSize.sm, fontWeight: '600', color: Colors.textSecondary },
  clubTextActive: { color: Colors.darkGreen, fontWeight: '700' },
  actions: { flexDirection: 'row', gap: Spacing.sm, marginTop: Spacing.xs },
  discardBtn: {
    flex: 1, paddingVertical: 14, borderRadius: Radius.circle,
    alignItems: 'center',
    borderWidth: 1.5, borderColor: Colors.border,
  },
  discardText: { fontSize: FontSize.base, fontWeight: '600', color: Colors.textSecondary },
  saveBtn: {
    flex: 2, paddingVertical: 14, borderRadius: Radius.circle,
    alignItems: 'center',
...
const permStyles = StyleSheet.create({
  ...
  title: { fontSize: FontSize.xl, fontWeight: '800', color: Colors.textPrimary, marginBottom: Spacing.sm, textAlign: 'center' },
  sub: { fontSize: FontSize.base, color: Colors.textSecondary, textAlign: 'center', lineHeight: 24, marginBottom: Spacing.xl },
  btn: { backgroundColor: Colors.darkGreen, borderRadius: Radius.circle, paddingVertical: 14, paddingHorizontal: Spacing.xxl, marginBottom: Spacing.md },
