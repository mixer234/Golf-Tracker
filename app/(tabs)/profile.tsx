...
const infoStyles = StyleSheet.create({
  ...
  value: { fontSize: FontSize.base, fontWeight: '600', color: Colors.textPrimary, flexShrink: 0 },
});
...
const styles = StyleSheet.create({
  ...
  editBtnText: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.darkGreen },
  ...
  chipTextSelected: { color: Colors.darkGreen, fontWeight: '700' },
